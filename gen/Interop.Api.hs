...
getUsers_ByUsersNames :: forall qp. QueryParam qp => [qp] -> [String] -> ApiEff SpecificApiOptions (Either (ApiError ApplicationError) UserResponses)
getUsers_ByUsersNames params _ByUsersNames = handleError <$> getAt (map qp params <> map qp [ByUsersNames _ByUsersNames]) ["users"]

getUsers_ByUsersNames' :: [String] -> ApiEff SpecificApiOptions (Either (ApiError ApplicationError) UserResponses)
getUsers_ByUsersNames' _ByUsersNames = handleError <$> getAt [ByUsersNames _ByUsersNames] ["users"]

getUsers_ByUsersEmails :: forall qp. QueryParam qp => [qp] -> [String] -> ApiEff SpecificApiOptions (Either (ApiError ApplicationError) UserResponses)
getUsers_ByUsersEmails params _ByUsersEmails = handleError <$> getAt (map qp params <> map qp [ByUsersEmails _ByUsersEmails]) ["users"]

getUsers_ByUsersEmails' :: [String] -> ApiEff SpecificApiOptions (Either (ApiError ApplicationError) UserResponses)
getUsers_ByUsersEmails' _ByUsersEmails = handleError <$> getAt [ByUsersEmails _ByUsersEmails] ["users"]

getUser_ByUserActive :: forall qp. QueryParam qp => [qp] -> Int64 -> Bool -> ApiEff SpecificApiOptions (Either (ApiError ApplicationError) UserResponse)
...
getUser_ByUserActive' :: Int64 -> Bool -> ApiEff SpecificApiOptions (Either (ApiError ApplicationError) UserResponse)
...
getUserText :: forall qp. QueryParam qp => [qp] -> String -> ApiEff SpecificApiOptions (Either (ApiError ApplicationError) UserResponse)
...
putUserText :: forall qp. QueryParam qp => [qp] -> String -> UserRequest -> ApiEff SpecificApiOptions (Either (ApiError ApplicationError) UserResponse)
...
deleteUserText :: forall qp. QueryParam qp => [qp] -> String -> ApiEff SpecificApiOptions (Either (ApiError ApplicationError) ())
deleteUserText params user_name = handleError <$> deleteAt params ["user_text", user_name]

deleteUserText' :: String -> ApiEff SpecificApiOptions (Either (ApiError ApplicationError) ())
deleteUserText' user_name = handleError <$> deleteAt ([] :: [(Text, Text)]) ["user_text", user_name]

getUserString :: forall qp. QueryParam qp => [qp] -> [Char] -> ApiEff SpecificApiOptions (Either (ApiError ApplicationError) UserResponse)
getUserString params user_name = handleError <$> getAt params ["user_string", T.pack $ show user_name]

getUserString' :: [Char] -> ApiEff SpecificApiOptions (Either (ApiError ApplicationError) UserResponse)
getUserString' user_name = handleError <$> getAt ([] :: [(Text, Text)]) ["user_string", T.pack $ show user_name]

putUserString :: forall qp. QueryParam qp => [qp] -> [Char] -> UserRequest -> ApiEff SpecificApiOptions (Either (ApiError ApplicationError) UserResponse)
putUserString params user_name user_request = handleError <$> putAt params ["user_string", T.pack $ show user_name] user_request

putUserString' :: [Char] -> UserRequest -> ApiEff SpecificApiOptions (Either (ApiError ApplicationError) UserResponse)
putUserString' user_name user_request = handleError <$> putAt ([] :: [(Text, Text)]) ["user_string", T.pack $ show user_name] user_request

deleteUserString :: forall qp. QueryParam qp => [qp] -> [Char] -> ApiEff SpecificApiOptions (Either (ApiError ApplicationError) ())
deleteUserString params user_name = handleError <$> deleteAt params ["user_string", T.pack $ show user_name]

deleteUserString' :: [Char] -> ApiEff SpecificApiOptions (Either (ApiError ApplicationError) ())
