...
getUsers_ByUsersEmails :: forall qp. QueryParam qp => Array qp -> (Array String) -> ApiEff (Either (ApiError ApplicationError) UserResponses)
getUsers_ByUsersEmails params _ByUsersEmails = handleError <$> getAt (map qp params <> map qp [ByUsersEmails _ByUsersEmails]) ["users"]

getUsers_ByUsersEmails' :: (Array String) -> ApiEff (Either (ApiError ApplicationError) UserResponses)
getUsers_ByUsersEmails' _ByUsersEmails = handleError <$> getAt [ByUsersEmails _ByUsersEmails] ["users"]

getUser_ByUserActive :: forall qp. QueryParam qp => Array qp -> Int -> Boolean -> ApiEff (Either (ApiError ApplicationError) UserResponse)
...
getUser_ByUserActive' :: Int -> Boolean -> ApiEff (Either (ApiError ApplicationError) UserResponse)
...
getUserText :: forall qp. QueryParam qp => Array qp -> String -> ApiEff (Either (ApiError ApplicationError) UserResponse)
...
putUserText :: forall qp. QueryParam qp => Array qp -> String -> UserRequest -> ApiEff (Either (ApiError ApplicationError) UserResponse)
...
deleteUserText :: forall qp. QueryParam qp => Array qp -> String -> ApiEff (Either (ApiError ApplicationError) Unit)
deleteUserText params user_name = handleError <$> deleteAt params ["user_text", user_name]

deleteUserText' :: String -> ApiEff (Either (ApiError ApplicationError) Unit)
deleteUserText' user_name = handleError <$> deleteAt ([] :: Array Boolean) ["user_text", user_name]

getUserString :: forall qp. QueryParam qp => Array qp -> String -> ApiEff (Either (ApiError ApplicationError) UserResponse)
getUserString params user_name = handleError <$> getAt params ["user_string", user_name]

getUserString' :: String -> ApiEff (Either (ApiError ApplicationError) UserResponse)
getUserString' user_name = handleError <$> getAt ([] :: Array Boolean) ["user_string", user_name]

putUserString :: forall qp. QueryParam qp => Array qp -> String -> UserRequest -> ApiEff (Either (ApiError ApplicationError) UserResponse)
putUserString params user_name user_request = handleError <$> putAt params ["user_string", user_name] user_request

putUserString' :: String -> UserRequest -> ApiEff (Either (ApiError ApplicationError) UserResponse)
putUserString' user_name user_request = handleError <$> putAt ([] :: Array Boolean) ["user_string", user_name] user_request

deleteUserString :: forall qp. QueryParam qp => Array qp -> String -> ApiEff (Either (ApiError ApplicationError) Unit)
deleteUserString params user_name = handleError <$> deleteAt params ["user_string", user_name]

deleteUserString' :: String -> ApiEff (Either (ApiError ApplicationError) Unit)
